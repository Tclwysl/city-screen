...
//客流
    $(function(){
        var myChart = echarts.init($("#track")[0]);
        var option = {
title: {
        text: '站点高峰客流',
			subtext: '客流：万人次',
            ...
            series : [
                {
                    ...
                    data:[0, 184, 115, 65, 30, 0]
                },
                {
                    name:'客流',
                    type:'bar',
                    stack: '总量',
                    data:[254, 70, 69, 50, 35, 30],
                    itemStyle: {
                        normal: {
                            color: '#2481ff'
                        }
...
// 支出渠道分析
    $(function(){
        var myChart = echarts.init($("#roadcons")[0]);
        option = {
    title: {
        text: '项目类型统计',
		textStyle: {
...
// 事件类型分析
    $(function(){
    //    var dom = document.getElementById("gcsurvey2");
var myChart = echarts.init($("gcsurvey2")[0]);
...
var option = {
    ...
    dataset: {
        source: [
          //  ['product','2018年', '2019年', '2020年', '2021年'],

            
            ['城市道路', 86.5, 92.1, 85.7, 83.1, 73.4, 55.1],
            ['建构筑物', 41.1, 30.4, 65.1, 53.3, 83.8, 98.7],
            ['地表覆盖', 24.1, 67.2, 79.5, 86.4, 65.2, 82.5],
            ['行政区域', 55.2, 67.1, 69.2, 72.4, 53.9, 39.1]
        ]
    },
    series: [{
        type: 'pie',
